...
<div <?php echo $wrapper_attributes; ?>>
        ...
        <div class="swiper" id="<?php echo esc_attr( $block_id ); ?>">
            <div class="swiper-wrapper">
                <?php foreach ( $categories as $category ) : 
                    echo wc_category_display_render_category_item( $category, $show_count, 'swiper-slide' );
                endforeach; ?>
            </div>
    ...
    <?php else : ?>
        ...
        <div class="wc-cat-grid-container">
            <?php foreach ( $categories as $category ) : 
                echo wc_category_display_render_category_item( $category, $show_count );
            endforeach; ?>
        </div>
    <?php endif; ?>
</div>
 ...
 */
if ( ! function_exists( 'wc_category_display_render_category_item' ) ) {
    function wc_category_display_render_category_item( $category, $show_count = false, $extra_class = '' ) {
